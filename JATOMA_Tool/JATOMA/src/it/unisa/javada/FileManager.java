...
public class FileManager {
	...
	public static String getSrcDirName(String path) {
		List<String> files = new ArrayList<String>();
		...
		if(!files.isEmpty()) {
			...
			return file.substring(file.indexOf("src"), file.lastIndexOf("\\"));
		}
		System.out.println("Error retrieving src files path, files not found");
		return "";
	}
	...
	public static String trim(String s) {
		//this method remove extension from filename
		if(s!=null) {
