...
//			System.out.println("root null");
	...
	public static void addTextArea(String name, Integer rows, Integer columns) {
...
//		add_component(dialog);
	...
	public static void addLabel(pLabel name,Element root){
		...
		if(name.getFont()!=null) {
			...
			font.appendChild(doc.createTextNode(name.getName()));
			label.appendChild(font);
		}
		else{
			label.appendChild(doc.createTextNode(name.getName()));
		}
